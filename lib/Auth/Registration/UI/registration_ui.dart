...
//   }
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              ...
              InkWell(
                onTap: () async {
                  getImage(ImageSource.camera, context, i);
                },
                child: Container(
                  child: ListTile(
                    title:  Text("Camera"),
  ...
  Future<void> getFromGallery(int i) async {
    ...
    if (image != null) {
      setState(() {
        ...
        // else if(i==8){
        //   adharBackImage = File(image.path);
        // }
        // else if(i==9){
        //   adharFrontImage = File(image.path);
        // }
        // else if(i==10){
  ...
  Future getImage(ImageSource source, BuildContext context, int i) async {
    ...
    setState(() {
      _image = File(image?.path ?? '');
      getCropImage(context, i);
    });
  }

  void getCropImage(BuildContext context, i) async {
    File? croppedFile = await ImageCropper().cropImage(
